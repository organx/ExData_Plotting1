...
Sub_metering_1 <- as.numeric(df2$Sub_metering_1)
Sub_metering_2 <- as.numeric(df2$Sub_metering_2)
Sub_metering_3 <- as.numeric(df2$Sub_metering_3)
legend_text <- names(df[7:9])
